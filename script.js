...
function renderSlideLayers() {
    ...
    var statLabels = ['معدل النجاح', 'نمو الإيرادات', 'زيادة المبيعات', 'رضا العملاء', 'التقييم', 'عدد المستخدمين', 'الكفاءة', 'التوصيات'];
    var chartLabels = ['يناير', 'فبراير', 'مارس', 'أبريل', 'مايو', 'يونيو'];
    ...
    currentPres.slides.forEach(function(slide, i) {
        ...
        if (slide.type === 'title') {
            // TITLE SLIDE - Rich with decorative elements
            html = '<div class="sl-pattern-grid"></div>' +
                   ...
                   '<div class="sl-deco-dots sl-deco-dots-1"></div>' +
                   '<div class="sl-deco-dots sl-deco-dots-2"></div>' +
            ...
            var layout = i % 5; // 5 different layouts

            if (layout === 0) {
                // Layout 1: Standard with large icon
                ...
                // Layout 2: Two columns with visual box
                html = '<div class="sl-pattern-dots"></div>' +
                       '<div class="sl-content-twocol">' +
                       ...
                       '<div class="sl-accent-line" style="background: ' + slide.accent + '"></div>' +
                       '<ul class="sl-list">' +
                       slide.points.slice(0, 2).map(function(p) {
                           return '<li style="border-right-color: ' + slide.accent + '">' +
                                  '<span class="sl-bullet" style="background: ' + slide.accent + '"></span>' +
                                  escapeHtml(p) + '</li>';
                       }).join('') +
                       ...
                       '<div class="sl-visual-box" style="background: linear-gradient(135deg, ' + slide.accent + ', ' + slide.accent + '88);">' +
                       '<span class="sl-visual-icon">' + icon + '</span>' +
                       '</div>' +
                       '</div>' +
                       '</div>' +
                       '<div class="sl-num">' + (i + 1) + ' / ' + currentPres.slides.length + '</div>';
                ...
                html = '<div class="sl-pattern-dots"></div>' +
                       ...
                       '</div>' +
                       '<div class="sl-accent-line" style="background: ' + slide.accent + '"></div>' +
                       '<ul class="sl-list" style="margin-bottom: 25px;">' +
        ...
        // Render chart if this slide has a canvas
